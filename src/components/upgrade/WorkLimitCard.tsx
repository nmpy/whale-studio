...
// src/components/upgrade/WorkLimitCard.tsx
// 作品数上限到達時のアップグレード誘導カード（プラン名に依存しない汎用版）
//
// 旧称: TesterUpgradeCard（Phase 5 でリネーム。後方互換 re-export は同ディレクトリの
//       TesterUpgradeCard.tsx を参照）
//
// variant:
...
export interface WorkLimitCardProps {
        ...
        <div style={{ display: "flex", alignItems: "flex-start", gap: 10, flex: 1, minWidth: 0 }}>
          ...
          <div>
            ...
            <div style={{ fontSize: 12, color: "var(--text-secondary)" }}>
              追加で作品を作成するには、上位プランへのアップグレードが必要です。
            </div>
          </div>
        </div>

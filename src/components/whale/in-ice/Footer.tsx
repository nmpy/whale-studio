...
export function Footer() {
  ...
  return (
    <footer className="px-6 md:px-10 lg:px-12 py-12 md:py-16 border-t border-[color:var(--ice-border)]">
      <div className="mx-auto w-full max-w-[1100px] flex flex-col md:flex-row md:items-center md:justify-between gap-6">
        <div>
          <p className="ice-serif text-[15px] md:text-[16px] text-[color:var(--ice-text)] mb-1">
            氷のくじら — Whale in Ice
          </p>

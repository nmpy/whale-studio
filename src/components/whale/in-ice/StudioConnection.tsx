  ...
  return (
    <Section id="studio">
      <SectionHeading
        ...
        title={
          <>
            技術基盤としての<br className="md:hidden" />
            Whale Studio。
          </>
        }
      />
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12 items-start">
        <div className="md:col-span-7">
          <p className="text-[15px] md:text-[16px] leading-[2.1] text-[color:var(--ice-text)]">
            ...
            <span className="ice-serif px-1 text-[color:var(--ice-accent-strong)]">Whale Studio</span>
            に支えられています。
          </p>
          <p className="text-[14px] md:text-[15px] leading-[2.0] text-[color:var(--ice-text-muted)] mt-5">
          ...
          <p className="text-[12px] md:text-[13px] leading-[1.9] text-[color:var(--ice-text-faint)] mt-5">
            ※ 主役は物語と体験です。Whale Studio はその裏で静かに動く技術として位置づけています。
          </p>
        </div>

        {/* 右カラム: 静かなパネル + リンク */}
        <aside className="md:col-span-5">
          <div className="rounded-2xl border border-[color:var(--ice-border-strong)] bg-[color:var(--ice-surface)]/80 p-6 md:p-7">
            <p className="ice-serif text-[15px] md:text-[16px] text-[color:var(--ice-text)] mb-2">
              Whale Studio
            </p>
            <p className="text-[12px] md:text-[13px] leading-[1.9] text-[color:var(--ice-text-muted)] mb-5">
              LINE で物語体験をつくる SaaS / 運用基盤。<br />

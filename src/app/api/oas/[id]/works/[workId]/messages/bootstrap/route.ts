    ...
    try {
      ...
      const work = await withTiming("api/messages-bootstrap:db:work", () =>
        prisma.work.findUnique({
          ...
          select: {
            ...
            welcomeLoadingSeconds: true,
            followAction:      true,
            startTriggerMode:  true,
            publishStatus:     true,
            liffEnabled:       true,
            resumeEnabled:     true,
      ...
      const payload = {
        ...
        work: {
          ...
          welcome_loading_seconds: work.welcomeLoadingSeconds ?? 0,
          follow_action:       (work.followAction as "auto_start" | "welcome_wait" | "none" | undefined) ?? "auto_start",
          start_trigger_mode:  (work.startTriggerMode as "keyword" | "free_text" | undefined) ?? "keyword",
